...
def main() -> None:
    ...
    axes[0, 2].scatter(X_moons[:, 0], X_moons[:, 1], c=labels_moons_dbscan, 
                       s=20, cmap='tab10', edgecolors='none')
    axes[0, 2].set_title("DBSCAN on Moons (eps=0.15, min_pts=5)")
    ...
    axes[1, 2].scatter(X_blobs[:, 0], X_blobs[:, 1], c=labels_blobs_dbscan, 
                       s=20, cmap='tab10', edgecolors='none')
    axes[1, 2].set_title("DBSCAN on Blobs (eps=1.5, min_pts=5)")
