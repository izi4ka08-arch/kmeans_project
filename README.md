...
Реализация **k-means** (алгоритм Ллойда) и **DBSCAN** **на чистом C**: библиотечная функция для кластеризации, CLI-демо для работы с CSV, генерация синтетических данных и визуализация результатов.
